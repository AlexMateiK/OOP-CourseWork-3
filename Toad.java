 ...
 * Toads age, move, eat fern, mate, and die.
 * 
...
public class Toad extends Animal
{
    ...
    private static final double DISEASE_SPREADING_PROBABILITY = 0.25;
 
    //Maximum age this species may live up to when sick.
    private static final int DISEASED_MAX_AGE = 30;
 
    //How likely this species is to breed when sick.
    private static final double DISEASED_BREEDING_PROBABILITY = 0.3;
     ...
     */
    public Toad(boolean randomAge, Field field, Location location, Simulator simulator)
    {
