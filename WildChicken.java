...
/**
 * A simple model of a wild chicken.
 * Wild chicken age, move, eat fern, mate, and die.
 * 
 ...
 */
public class WildChicken extends Animal
{
    ...
    private static final boolean IS_HERBIVORE = true;
 
    //A shared random number generator to control breeding.
    private static final Random rand = Randomizer.getRandom();
 
    //How likely this species is to spread disease.
    private static final double DISEASE_SPREADING_PROBABILITY = 0.2;
    ...
    private static final double DISEASED_BREEDING_PROBABILITY = 0.36;
 
    //Max number of offspring this species may create when sick.
    private static final int DISEASED_MAX_LITTER_SIZE = 3;
 
    //How many steps this animal will survive after each meal, when sick
    private static final int DISEASED_FOOD_VALUE = 25;
     ...
     */
    public WildChicken(boolean randomAge, Field field, Location location, Simulator simulator)
    {
