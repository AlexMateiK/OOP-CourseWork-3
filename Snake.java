 ...
 * Snakes age, move, eat rats and toads, mate, and die.
 * 
...
public class Snake extends Animal
{
    ...
    private static final double DISEASE_SPREADING_PROBABILITY = 0.12;
    ...
    private static final double DISEASED_BREEDING_PROBABILITY = 0.47;
     ...
     */
    public Snake(boolean randomAge, Field field, Location location, Simulator simulator)
    {
