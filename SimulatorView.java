...
public class SimulatorView extends JFrame
{
    ...
    private JLabel stepLabel, populationAndTime, infoLabel, timeOfDayLabel;
    ...
    public SimulatorView(int height, int width)
    {
        ...
        populationAndTime = new JLabel(POPULATION_PREFIX + TIME_PREFIX, JLabel.CENTER);
        ...
        contents.add(populationAndTime, BorderLayout.SOUTH);
     ...
     */
    public void showStatus(int step, int noOfDiseased, Field field, Field plantField)
    {
        if(!isVisible()) {
            setVisible(true);
        }
